...
impl Action {
    ...
    /// it resolves to came from a file, which is the only kind logman may
    /// rewrite or remove.
...
impl SettingsDialog {
    ...
    /// starting point they can edit outside logman. Whether an existing file
...
/// wants logman to *load* has to end up — but only once it exists: a save
