...
//!
//! The translations themselves live in `crates/logman-app/locales/<tag>.yml`
...
//!
//! 1. the tag stored in `settings.json`, when logman ships that language;
...
/// The locales logman ships translations for, as `(BCP 47 tag, endonym)`,
/// ordered by tag.
///
...
/// The endonym of `tag`, or `None` when logman ships no such translation.
...
///
/// `None`, a blank string, or a tag logman has no translation for all fall
