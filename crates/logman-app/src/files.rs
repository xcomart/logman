...
//! [`RemoteEntry`](logman_ssh::RemoteEntry). That is exactly right for as long
...
//!   backslashes the moment logman itself ran on Windows. The one place real
...
/// [`RemoteEntry`](logman_ssh::RemoteEntry) is already flat and owned — a name,
...
pub type FileEntry = logman_ssh::RemoteEntry;
...
pub trait FileSource {
    ...
    /// Whether this source is the computer logman itself is running on.
    ///
