//! The filesystem on the computer logman itself is running on.
//!
...
/// A source over the filesystem logman itself is running on.
///
...
impl FileSource for LocalSource {
    ...
    ///   [`FileEntry::is_dir`](logman_ssh::RemoteEntry::is_dir);
